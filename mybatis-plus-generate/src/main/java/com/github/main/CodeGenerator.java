...
public class CodeGenerator {
    ...
    private String[] tables = new String[]{"g_job_request"};//生成表名
    private String moduleDir = getOpPath("mybatis-plus-generate"); //所用模块路径;
    private final String packageParentName = "com.gizwits.module";//包路径
    private final String moduleName = "data";//模块包名
